...
class Login_Window:
    def __init__(self,root):
        ...
        img1 = Image.open(r"C:\Users\aryan\Desktop\Python\Hotel Managment Software for College Project\hotel1.jpeg")
        img1 = img1.resize((1530,800))
        self.photoImg1 = ImageTk.PhotoImage(img1)
        bg_lbl=Label(self.root,image=self.photoImg1)
        bg_lbl.place(x=0,y=0,width=1530,height=800)

        title=Label(bg_lbl,text="Hotel Managment System",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        myname=Label(self.root,text="Developed By:Code Crafters",fg="black",bg="white",font=("times new roman",18,"bold"))
        myname.place(x=0,y=0)
        
        img10 = Image.open(r"C:\Users\aryan\Desktop\Python\Hotel Managment Software for College Project\hotel2.png")
        img10 = img10.resize((500,120) )
        self.photoImg10 = ImageTk.PhotoImage(img10)
        bg_lbl1=Label(bg_lbl,image=self.photoImg10)
        bg_lbl1.place(x=0,y=0,width=500,height=120)

        img11 = Image.open(r"C:\Users\aryan\Desktop\Python\Hotel Managment Software for College Project\hotel3.jpeg")
        img11 = img11.resize((500,120))
        self.photoImg11 = ImageTk.PhotoImage(img11)
        bg_lbl22=Label(bg_lbl,image=self.photoImg11)
        bg_lbl22.place(x=500,y=0,width=500,height=120)

        img13 = Image.open(r"C:\Users\aryan\Desktop\Python\Hotel Managment Software for College Project\images.jpeg")
        img13 = img13.resize((550,120))
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.combo_securiy_Q["values"]=("Select","Your Birth Place","Your Best Friend Name","Your Pet Name")
